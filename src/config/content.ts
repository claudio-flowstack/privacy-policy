...
export const flowstackSystem = {
  ...
  stages: [
    ...
    },
    {
      ...
      icon: "PenTool",
      title: "ARCHITEKTUR",
      subtitle: "Dein System wird designt",
      duration: "Woche 1-2",
      description: "Wir bauen die Blaupause für deine Automation.",
      items: [
        "Individuelle Workflow-Architektur für deine Agentur",
        "Auswahl der optimalen Tools und KI-Integrationen",
      ],
      result: "Ein fertiger Plan, der zu deinem Business passt.",
    },
    {
      number: "3",
      icon: "Rocket",
