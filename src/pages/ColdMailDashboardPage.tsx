        ...
        <header className="sticky top-0 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border-b border-gray-100 dark:border-gray-800 z-30">
          <div className="flex items-center justify-between px-6 py-4">
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm text-gray-500">{stats.activeCampaigns} {tx('aktive Kampagnen', 'active campaigns')} · {stats.sent} {tx('gesendet', 'sent')} · {stats.replyRate}% {tx('Antwortrate', 'reply rate')}</p>
              </div>
            </div>
